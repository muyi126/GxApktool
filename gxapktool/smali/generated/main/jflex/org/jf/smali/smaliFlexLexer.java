 ...
 * from the specification file <tt>smali/smali/smali/src/main/jflex/smaliLexer.jflex</tt>
 */
public class smaliFlexLexer implements TokenSource, LexerErrorInterface {
  ...
  protected static final int ZZ_BUFFERSIZE = 16384;
   ...
   */
  protected static final int ZZ_LEXSTATE[] = { 
   ...
   */
  protected static final String ZZ_CMAP_PACKED = 
   ...
   * Translates characters to character classes
   */
  protected static final char [] ZZ_CMAP = zzUnpackCMap(ZZ_CMAP_PACKED);

  /** 
   * Translates DFA states to action switch labels.
   */
  protected static final int [] ZZ_ACTION = zzUnpackAction();

  protected static final String ZZ_ACTION_PACKED_0 =
   ...
   */
  protected static final int [] ZZ_ROWMAP = zzUnpackRowMap();

  protected static final String ZZ_ROWMAP_PACKED_0 =
   ...
   */
  protected static final int [] ZZ_TRANS = zzUnpackTrans();

  protected static final String ZZ_TRANS_PACKED_0 =
  ...
  protected static int [] zzUnpackTrans() {
  ...
  protected static int zzUnpackTrans(String packed, int offset, int [] result) {
    int i = 0;       /* index in packed string  */
    int j = offset;  /* index in unpacked array */
    int l = packed.length();
    while (i < l) {
  ...
  /* error codes */
  protected static final int ZZ_UNKNOWN_ERROR = 0;
  protected static final int ZZ_NO_MATCH = 1;
  protected static final int ZZ_PUSHBACK_2BIG = 2;

  /* error messages for the codes above */
  protected static final String ZZ_ERROR_MSG[] = {
   ...
   */
  protected static final int [] ZZ_ATTRIBUTE = zzUnpackAttribute();
  ...
  /** the input device */
  protected Reader zzReader;

  /** the current state of the DFA */
  protected int zzState;
  ...
  protected char zzBuffer[] = new char[ZZ_BUFFERSIZE];

  /** the textposition at the last accepting state */
  protected int zzMarkedPos;

  /** the current text position in the buffer */
  protected int zzCurrentPos;

  /** startRead marks the beginning of the yytext() string in the buffer */
  protected int zzStartRead;

  /** endRead marks the last character in the buffer, that has been read
      from input */
  protected int zzEndRead;
  ...
  protected boolean zzAtEOF;

  /** denotes if the user-EOF-code has already been executed */
  protected boolean zzEOFDone;
   ...
   */
  protected int zzFinalHighSurrogate = 0;

  /* user code: */
    protected StringBuffer sb = new StringBuffer();
    protected String stringOrCharError = null;
    protected int stringStartLine;
    protected int stringStartCol;
    protected int stringStartChar;

    protected int lexerErrors = 0;
    ...
    protected Token newToken(int type, String text, boolean hidden) {
    ...
    protected Token newToken(int type, boolean hidden) {
    ...
    protected Token invalidToken(String message, String text) {
    ...
    protected Token invalidToken(String message) {
    ...
    protected Token endStringOrChar(int type) {
        yybegin(YYINITIAL);
    ...
    protected Token invalidStringOrChar(String message) {
        yybegin(YYINITIAL);
   ...
   */
  protected boolean zzRefill() throws IOException {
   ...
   */
  protected void zzScanError(int errorCode) {
    String message;
    try {
