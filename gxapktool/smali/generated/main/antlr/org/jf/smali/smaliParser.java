...
public class smaliParser extends Parser {
	...
	public final smali_file_return smali_file() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: super_spec, source_spec, method, field, class_spec, implements_spec
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					// AST REWRITE
					// elements: nonvoid_type_descriptor, annotation, literal, member_name, access_list
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: member_name, nonvoid_type_descriptor, access_list, literal
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final statements_and_directives_return statements_and_directives() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: registers_directive, catch_directive, ordered_method_item, parameter_directive, catchall_directive
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final local_directive_return local_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, NULL_LITERAL, nonvoid_type_descriptor, name, signature
	...
	public final insn_format45cc_method_return insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: register_list, method_prototype, method_reference, INSTRUCTION_FORMAT45cc_METHOD
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format4rcc_method_return insn_format4rcc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method_reference, register_range, method_prototype, INSTRUCTION_FORMAT4rcc_METHOD
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_array_data_directive_return insn_array_data_directive() throws RecognitionException {
		...
		try {
			...
			stream_parsed_integer_literal.add(parsed_integer_literal490.getTree());
			        ...
			        int elementWidth = (parsed_integer_literal490!=null?((parsed_integer_literal_return)parsed_integer_literal490).value:0);
