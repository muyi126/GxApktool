		...
		try {
			...
			state._fsp--;
			        ...
			        method_stack.peek().methodParameterRegisters =
			                MethodUtil.getParameterRegisterCount((method_name_and_prototype67!=null?((method_name_and_prototype_return)method_name_and_prototype67).parameters:null), method_stack.peek().isStatic);
			...
			switch (alt16) {
				case 1 :
					...
					state._fsp--;
					          ...
					          if ((registers_directive68!=null?((registers_directive_return)registers_directive68).isLocalsDirective:false)) {
					            method_stack.peek().totalMethodRegisters = (registers_directive68!=null?((registers_directive_return)registers_directive68).registers:0) + method_stack.peek().methodParameterRegisters;
					          } else {
					            method_stack.peek().totalMethodRegisters = (registers_directive68!=null?((registers_directive_return)registers_directive68).registers:0);
					          }
			...
			parameters((method_name_and_prototype67!=null?((method_name_and_prototype_return)method_name_and_prototype67).parameters:null));
			state._fsp--;
			...
			match(input, Token.UP, null); 
			    ...
			    ret = dexBuilder.internMethod(
			            classType,
			            (method_name_and_prototype67!=null?((method_name_and_prototype_return)method_name_and_prototype67).name:null),
			            (method_name_and_prototype67!=null?((method_name_and_prototype_return)method_name_and_prototype67).parameters:null),
			            (method_name_and_prototype67!=null?((method_name_and_prototype_return)method_name_and_prototype67).returnType:null),
			            accessFlags,
			            annotations71,
	...
	public final method_name_and_prototype_return method_name_and_prototype() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    int paramRegister = 0;
			    for (String type: (method_prototype75!=null?((method_prototype_return)method_prototype75).parameters:null)) {
			    ...
			    retval.returnType = (method_prototype75!=null?((method_prototype_return)method_prototype75).returnType:null);
			...
			while (true) {
				...
				case 1 :
					...
					state._fsp--;
					        ...
					        types.add((nonvoid_type_descriptor76!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor76).type:null));
	...
	public final ImmutableMethodReference method_reference() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    String type;
			    if ((reference_type_descriptor77!=null?((reference_type_descriptor_return)reference_type_descriptor77).type:null) == null) {
			        type = classType;
			    } else {
			        type = (reference_type_descriptor77!=null?((reference_type_descriptor_return)reference_type_descriptor77).type:null);
			    }
			    methodReference = new ImmutableMethodReference(type, (SIMPLE_NAME78!=null?SIMPLE_NAME78.getText():null),
			             (method_prototype79!=null?((method_prototype_return)method_prototype79).parameters:null), (method_prototype79!=null?((method_prototype_return)method_prototype79).returnType:null));
	...
	public final ImmutableFieldReference field_reference() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    String type;
			    if ((reference_type_descriptor80!=null?((reference_type_descriptor_return)reference_type_descriptor80).type:null) == null) {
			        type = classType;
			    } else {
			        type = (reference_type_descriptor80!=null?((reference_type_descriptor_return)reference_type_descriptor80).type:null);
			    }
			    fieldReference = new ImmutableFieldReference(type, (SIMPLE_NAME81!=null?SIMPLE_NAME81.getText():null),
			            (nonvoid_type_descriptor82!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor82).type:null));
	...
	public final void catch_directive() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			    ...
			    method_stack.peek().methodBuilder.addCatch(dexBuilder.internTypeReference((nonvoid_type_descriptor85!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor85).type:null)),
			        from, to, using);
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      method_stack.peek().methodBuilder.addStartLocal(registerNumber,
			              ...
			              dexBuilder.internNullableTypeReference((nonvoid_type_descriptor92!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor92).type:null)),
	...
	public final void insn_format21c_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction21c(opcode, regA,
			              dexBuilder.internTypeReference((nonvoid_type_descriptor125!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor125).type:null))));
	...
	public final void insn_format22c_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction22c(opcode, regA, regB,
			              dexBuilder.internTypeReference((nonvoid_type_descriptor142!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor142).type:null))));
	...
	public final void insn_format35c_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      byte[] registers = (register_list162!=null?((register_list_return)register_list162).registers:null);
			      byte registerCount = (register_list162!=null?((register_list_return)register_list162).registerCount:0);
	...
	public final void insn_format35c_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      //this depends on the fact that register_list returns a byte[5]
			      byte[] registers = (register_list165!=null?((register_list_return)register_list165).registers:null);
			      byte registerCount = (register_list165!=null?((register_list_return)register_list165).registerCount:0);

			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction35c(opcode, registerCount, registers[0], registers[1],
			              registers[2], registers[3], registers[4], dexBuilder.internTypeReference((nonvoid_type_descriptor166!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor166).type:null))));
	...
	public final void insn_format3rc_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      int startRegister = (register_range168!=null?((register_range_return)register_range168).startRegister:0);
			      int endRegister = (register_range168!=null?((register_range_return)register_range168).endRegister:0);
	...
	public final void insn_format3rc_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      int startRegister = (register_range171!=null?((register_range_return)register_range171).startRegister:0);
			      int endRegister = (register_range171!=null?((register_range_return)register_range171).endRegister:0);

			      int registerCount = endRegister-startRegister+1;

			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction3rc(opcode, startRegister, registerCount,
			              dexBuilder.internTypeReference((nonvoid_type_descriptor172!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor172).type:null))));
	...
	public final void insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      //this depends on the fact that register_list returns a byte[5]
			      byte[] registers = (register_list174!=null?((register_list_return)register_list174).registers:null);
			      byte registerCount = (register_list174!=null?((register_list_return)register_list174).registerCount:0);
			      ...
			      ImmutableMethodProtoReference methodProtoReference = new ImmutableMethodProtoReference(
			              (method_prototype176!=null?((method_prototype_return)method_prototype176).parameters:null),
			              (method_prototype176!=null?((method_prototype_return)method_prototype176).returnType:null));
	...
	public final void insn_format4rcc_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      int startRegister = (register_range178!=null?((register_range_return)register_range178).startRegister:0);
			      int endRegister = (register_range178!=null?((register_range_return)register_range178).endRegister:0);

			      int registerCount = endRegister-startRegister+1;

			      ImmutableMethodReference methodReference = method_reference179;
			      ImmutableMethodProtoReference methodProtoReference = new ImmutableMethodProtoReference(
			              (method_prototype180!=null?((method_prototype_return)method_prototype180).parameters:null),
			              (method_prototype180!=null?((method_prototype_return)method_prototype180).returnType:null));
		...
		try {
			...
			switch (alt40) {
				...
				case 2 :
					...
					type = (nonvoid_type_descriptor194!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor194).type:null);
					}
					break;
	...
	public final Annotation annotation() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      annotation = new ImmutableAnnotation(visibility, (subannotation216!=null?((subannotation_return)subannotation216).annotationType:null), (subannotation216!=null?((subannotation_return)subannotation216).elements:null));
